...
- **Repetidos:** a ficha mostra, de cada lado, qual fatura o lançamento abate e de onde ele veio, e tem três saídas: *São diferentes*, *Apagar o primeiro* e *Apagar o segundo* — quando o banco cobra e estorna, às vezes é o primeiro que precisa sair.
...
- **Publicado:** `caderneta-v32` (25/09/2026). O que existe está descrito acima; os commits contam a ordem.
