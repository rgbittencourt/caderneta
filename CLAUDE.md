...
- **Apagar uma fatura inteira:** *Corrigir fatura* tem *Apagar esta fatura* (dois toques), que remove os lançamentos daquela fatura e as parcelas seguintes dos planos que começaram nela, sem tocar no pagamento. É o caminho para reimportar uma fatura que entrou errada, sem precisar recomeçar do zero.
...
- **Publicado:** `caderneta-v23` (24/09/2026). O que existe está descrito acima; os commits contam a ordem.
